...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "RideShare — Rent cars, bikes & EVs near you" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/9Fqw0s8nIfV04662WALvNrgwsK33/social-images/social-1784889604550-11997.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/9Fqw0s8nIfV04662WALvNrgwsK33/social-images/social-1784889604550-11997.webp" },
    ],
    links: [
